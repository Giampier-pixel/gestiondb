...
<form method="post" class="w-lg shadow-xl shadow-gray-300 px-4 border border-gray-100">
    ...
    <div  class="flex flex-col">
        <label for="asistente" class="text-lg font-semibold text-gray-800 py-3">
            Asistente
        </label>
        <select class="p-2 text-lg text-gray-900 border border-amber-600" name="asistente" id="asistente">
